  ...
  <div>
    ...
    <div className="flex items-center max-w-[120px]">
      <button
        ...
        className="px-3 py-2 border-2 border-gray-300 dark:border-[#2d3748] bg-white dark:bg-[#252b3b] hover:bg-gray-100 dark:hover:bg-[#252b3b] rounded-l-md transition-all focus:outline-none focus:border-sky-600 focus:ring-2 focus:ring-sky-100 dark:focus:ring-blue-900/40"
      >
      ...
      <input
        ...
        className="w-16 px-2 py-2 border-t-2 border-b-2 border-gray-300 dark:border-[#2d3748] text-center bg-white dark:bg-[#252b3b] text-gray-900 dark:text-slate-200 transition-all focus:outline-none focus:border-sky-600 focus:ring-2 focus:ring-sky-100 dark:focus:ring-blue-900/40 [appearance:textfield] [&::-webkit-outer-spin-button]:appearance-none [&::-webkit-inner-spin-button]:appearance-none"
        min={min}
      />
      <button
        type="button"
        onClick={() => onChange(value + 1)}
        className="px-3 py-2 border-2 border-gray-300 dark:border-[#2d3748] bg-white dark:bg-[#252b3b] hover:bg-gray-100 dark:hover:bg-[#252b3b] rounded-r-md transition-all focus:outline-none focus:border-sky-600 focus:ring-2 focus:ring-sky-100 dark:focus:ring-blue-900/40"
      >
...
const DayCard = memo(({ selected, label, description, onClick }) => (
  <div
    ...
    className={`cursor-pointer rounded-xl p-5 border-2 transition-all duration-300 transform hover:scale-102 focus:outline-none focus-visible:ring-2 focus-visible:ring-sky-500 ${
      selected
        ? 'border-sky-600 bg-sky-50 shadow-lg scale-105'
        : 'border-gray-300 dark:border-[#2d3748] bg-white dark:bg-[#1a1f2e] hover:border-sky-400 hover:shadow-md'
    }`}
  >
    <div className="flex items-center justify-between mb-2">
      <span className="font-semibold text-gray-900 dark:text-slate-100">{label}</span>
      <div className={`w-6 h-6 rounded-full border-2 flex items-center justify-center transition-all ${
        selected ? 'border-sky-600 bg-sky-700' : 'border-gray-300'
      }`}>
      ...
      <div className="space-y-3">
        ...
        <div className="flex gap-2">
          <input
            ...
            className="flex-1 px-3 py-2.5 border-2 border-gray-300 dark:border-[#2d3748] rounded-md text-sm focus:outline-none bg-white dark:bg-[#252b3b] text-gray-900 dark:text-slate-200 placeholder:dark:text-slate-500 focus:border-sky-600 focus:ring-2 focus:ring-sky-100 dark:focus:ring-blue-900/40 transition-all"
          />
          <button
            type="button"
            onClick={handleAdd}
            className="px-4 py-2 bg-sky-700 text-white rounded-md hover:bg-sky-800 transition-colors font-medium"
          >
            Add
          </button>
        </div>
            ...
            <button
              ...
              className={`flex items-center gap-2 px-3 py-2 rounded-full border-2 text-sm font-medium transition-all ${
                selected
                  ...
                  : 'border-gray-300 dark:border-[#2d3748] bg-white dark:bg-[#252b3b] text-gray-700 dark:text-slate-300 hover:border-sky-400 hover:text-sky-700'
              }`}
            >
              <Icon size={14} />
              {name}
        ...
        {profile.selectedDays.custom && (
          <div className="mb-6 bg-gradient-to-br from-sky-50 to-indigo-50 rounded-xl p-6 border-2 border-sky-200">
            <div className="flex items-center justify-between mb-4">
              ...
              <button onClick={onToggleCustom} className="text-sky-700 hover:text-sky-700 font-medium text-sm flex items-center gap-1 transition-colors">
                  ...
                  <div
                    ...
                    className={`cursor-pointer rounded-lg p-3 border-2 transition-all focus:outline-none focus-visible:ring-2 focus-visible:ring-sky-500 ${
                      profile.customDays[day].selected
                        ? 'border-sky-600 bg-sky-100 shadow-md'
                        : 'border-gray-300 dark:border-[#2d3748] bg-white dark:bg-[#252b3b] hover:border-sky-400'
                    }`}
                  >
                    <div className="flex items-center gap-2">
                      <div className={`w-5 h-5 rounded border-2 flex items-center justify-center ${
                        profile.customDays[day].selected ? 'border-sky-600 bg-sky-700' : 'border-gray-300'
                      }`}>
            ...
            <div className="space-y-8">
              ...
              <div>
                ...
                <textarea
                  ...
                  className="w-full px-3 py-3 border-2 border-gray-300 dark:border-[#2d3748] rounded-md text-sm resize-y min-h-[120px] bg-white dark:bg-[#252b3b] text-gray-900 dark:text-slate-200 placeholder:dark:text-slate-500 transition-all focus:outline-none focus:border-sky-600 focus:ring-2 focus:ring-sky-100 dark:focus:ring-blue-900/40"
                  rows="4"
                />
              </div>
              ...
              <div>
                ...
                <div className="mb-5 pb-4 border-b border-gray-200 dark:border-[#1e293b]">
                  <div className="flex justify-between items-center mb-2 font-medium text-gray-900 dark:text-slate-100">
                    ...
                    <CheckCircle size={20} className="text-sky-700" />
                  </div>
