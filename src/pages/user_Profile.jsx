...
import slide3 from "../assets/lefttop.jpg"
import slide4 from "../assets/manufacturing.jpg"
import BackToTop from '../components/back_the_top_btn.jsx';
import { Link } from 'react-router-dom';

import { Star, CheckCircle, Users, User, Clock, Pencil, Phone, ChevronUp, ChevronDown, BriefcaseBusiness} from 'lucide-react';
...
export default function UserProfile() {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
     {/* Hero Section */}
      <div className="relative bg-gradient-to-br from-blue-600 to-blue-400 h-60 overflow-hidden">
        <img
          src={slide1}
          alt="banner cover"
        ...
        <div className="bg-white rounded-lg shadow-lg p-6">
          <div className="relative">
            <div className="absolute top-2 right-4">
              <button className="bg-white text-blue-600 px-4 py-2 rounded shadow hover:cursor-pointer hover:bg-blue-100">
      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        ...
        <div className="mt-8 flex items-center justify-center">
          <Link to="/userEdit">
          <button className="bg-blue-600 text-white lg:px-48 py-4 px-24 rounded-lg flex items-center justify-center space-x-2 hover:bg-blue-700">
