...
const ClientBookings = () => {
  ...
  const getUrgencyConfig = (urgency) => {
    const configs = {
      normal: { bg: 'bg-primary/10 dark:bg-blue-900/20', text: 'text-primary dark:text-blue-400', label: 'Normal' },
      ...
      >
        <div className="flex items-start justify-between mb-4">
          <div className="flex-1">
            <h3 className="text-xl font-bold text-gray-900 dark:text-slate-100 mb-2">{booking.title}</h3>
            <div className="flex items-center gap-2 text-gray-600 dark:text-slate-400 mb-2">
              ...
              <div className="flex items-center gap-1">
                ...
                <span className="text-sm font-semibold dark:text-slate-300">{booking.providerRating}</span>
              </div>
            </div>
            <p className="text-sm text-gray-600 dark:text-slate-400">{booking.providerProfession}</p>
          </div>
        ...
        <p className="text-gray-600 dark:text-slate-400 mb-4 line-clamp-2">{booking.description}</p>
        ...
        <div className="flex items-center justify-between pt-4 border-t border-gray-200 dark:border-[#1e293b]">
          <div className="flex items-center gap-2">
            ...
            <span className="text-xl font-bold text-gray-900 dark:text-slate-100">GH₵{booking.price}</span>
          </div>
          <div className="flex gap-2">
            {booking.status === 'completed' && booking.rating && (
              <div className="flex items-center gap-1 mr-2">
                <span className="text-sm text-gray-600 dark:text-slate-400">Rated:</span>
                <Star className="w-4 h-4 fill-yellow-400 text-yellow-400" />
                <span className="text-sm font-semibold dark:text-slate-300">{booking.rating}.0</span>
              </div>
            )}
            {/* [MOCK] Replace with GET /bookings/:id on click to fetch full booking detail */}
            <button
              onClick={() => setSelectedBooking(booking)}
              className="px-4 py-2 bg-white dark:bg-[#252b3b] border-2 border-primary text-primary rounded-lg hover:bg-primary/10 transition-colors text-sm font-semibold flex items-center gap-2"
            >
            ...
            <div className="sticky top-0 bg-white dark:bg-[#1a1f2e] border-b border-gray-200 dark:border-[#1e293b] p-6 flex items-center justify-between z-10">
              <div className="flex-1">
                <div className="flex items-center gap-3 mb-2">
                  <h2 className="text-2xl font-bold text-gray-900 dark:text-slate-100">{booking.title}</h2>
                  <span className="text-sm text-gray-500 dark:text-slate-500">#{booking.bookingReference}</span>
                </div>
            ...
            <div className="p-6 space-y-6">
              ...
              <div>
                ...
                <div className="bg-gray-50 dark:bg-[#252b3b] rounded-lg p-4">
                  <div className="flex items-start justify-between mb-4">
                    <div>
                      <p className="font-bold text-gray-900 dark:text-slate-100 text-lg">{booking.provider}</p>
                      <p className="text-gray-600 dark:text-slate-400">{booking.providerProfession}</p>
                      <div className="flex items-center gap-1 mt-2">
                        <Star className="w-5 h-5 fill-orange-500 text-orange-500" />
                        <span className="font-semibold text-gray-900 dark:text-slate-100">{booking.providerRating}</span>
                        <span className="text-gray-600 dark:text-slate-400 text-sm">(Based on reviews)</span>
                      </div>
                    </div>
                  </div>
              ...
              <div>
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-900 dark:text-slate-200 bg-gray-50 dark:bg-[#252b3b] rounded-lg p-3">{booking.description}</p>
                  </div>

                  <div className="grid md:grid-cols-3 gap-4">
                    <div>
                      <p className="text-sm text-gray-600 dark:text-slate-400 mb-1">Duration</p>
                      <p className="font-semibold text-gray-900 dark:text-slate-100">{booking.estimatedDuration || booking.duration}</p>
                    </div>
                    <div>
                    ...
                    <div>
                      <p className="text-sm text-gray-600 dark:text-slate-400 mb-1">Agreed Price</p>
                      <p className="font-semibold text-green-600 text-lg">GH₵{booking.price}</p>
                    </div>
                  </div>

                  <div className="bg-blue-50 dark:bg-blue-900/20 rounded-lg p-4">
                    <p className="text-sm text-gray-600 dark:text-slate-400 mb-1">Booking Date</p>
                    <p className="font-semibold text-gray-900 dark:text-slate-100">{booking.bookingDate}</p>
                  </div>
                </div>
              </div>
              ...
              <div>
                ...
                <div className="grid md:grid-cols-2 gap-4 bg-gray-50 dark:bg-[#252b3b] rounded-lg p-4">
                  <div>
                    <p className="text-sm text-gray-600 dark:text-slate-400 mb-1">Service Date & Time</p>
              ...
              <div>
                ...
                <div className="bg-gray-50 dark:bg-[#252b3b] rounded-lg p-4 space-y-3">
                  <div>
                    ...
                    <p className="font-semibold text-gray-900 dark:text-slate-100">{booking.address}</p>
                  </div>
                  <div className="grid md:grid-cols-2 gap-4">
                    <div>
                      <p className="text-sm text-gray-600 dark:text-slate-400 mb-1">Area</p>
                      <p className="font-semibold text-gray-900 dark:text-slate-100">{booking.area}, {booking.city}</p>
                    </div>
                    {booking.landmark && (
                      <div>
                        <p className="text-sm text-gray-600 dark:text-slate-400 mb-1">Landmark</p>
                        <p className="font-semibold text-gray-900 dark:text-slate-100">{booking.landmark}</p>
                      </div>
                    )}
                  </div>
                  {booking.postalCode && (
                    <div>
                      ...
                      <p className="font-semibold text-gray-900 dark:text-slate-100">{booking.postalCode}</p>
                    </div>
                  )}
                  <a
              ...
              {booking.additionalNotes && (
                <div>
                  <h3 className="text-lg font-bold text-gray-900 dark:text-slate-100 mb-4">Your Notes</h3>
              ...
              {booking.status === 'completed' && booking.review && (
                <div>
                  <h3 className="text-lg font-bold text-gray-900 dark:text-slate-100 mb-4">Your Review</h3>
                  ...
                  <div className="bg-green-50 dark:bg-green-900/20 rounded-lg p-4 border-l-4 border-green-400 dark:border-green-600">
                    ...
                    <p className="text-gray-900 dark:text-slate-200">{booking.review}</p>
                  </div>
                </div>
              )}
              ...
              {booking.status === 'cancelled' && booking.cancellationReason && (
                <div>
                  ...
                  <p className="text-gray-900 dark:text-slate-200 bg-red-50 dark:bg-red-900/20 rounded-lg p-4 border-l-4 border-red-400 dark:border-red-600">
            ...
            <div className="sticky bottom-0 bg-white dark:bg-[#1a1f2e] border-t border-gray-200 dark:border-[#1e293b] p-6">
              ...
              {booking.status === 'in-progress' && (
                <div className="flex gap-4">
                  ...
                  <button className="px-6 py-3 bg-white dark:bg-[#252b3b] border-2 border-gray-300 dark:border-[#2d3748] text-gray-700 dark:text-slate-300 rounded-lg hover:bg-gray-50 dark:hover:bg-[#2d3748] transition-colors font-semibold flex items-center gap-2">
      ...
      <AnimatePresence>
        ...
        >
          <motion.div
            ...
            animate={{ scale: 1, y: 0 }}
            exit={{ scale: 0.9, y: 50 }}
            className="bg-white dark:bg-[#1a1f2e] rounded-xl shadow-2xl max-w-md w-full"
            onClick={(e) => e.stopPropagation()}
          >
            <div className="p-6">
              <div className="flex items-center space-x-3 mb-4">
                <div className="bg-red-100 dark:bg-red-900/20 p-3 rounded-full">
                  <Trash2 className="w-6 h-6 text-error dark:text-red-400" />
                </div>
                <h2 className="text-xl font-semibold text-gray-900 dark:text-slate-100">Cancel Booking?</h2>
              </div>

              <p className="text-gray-600 dark:text-slate-400 mb-2">Are you sure you want to cancel this booking?</p>

              <div className="bg-gray-50 dark:bg-[#252b3b] p-4 rounded-lg mb-6 border border-gray-200 dark:border-[#1e293b]">
                <p className="text-sm font-semibold text-gray-900 dark:text-slate-100 mb-1">{booking.title}</p>
                <p className="text-sm text-gray-600 dark:text-slate-400 mb-1">Provider: {booking.provider}</p>
                <p className="text-sm text-gray-600 dark:text-slate-400">Date: {booking.date} at {booking.time}</p>
              </div>

              <div className="bg-yellow-50 dark:bg-amber-900/20 border-l-4 border-yellow-400 dark:border-amber-600 p-4 mb-6">
      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="text-3xl font-bold text-gray-900 dark:text-slate-100">My Bookings</h1>
              <p className="text-gray-600 dark:text-slate-400 mt-1">Track and manage all your service bookings</p>
            </div>
          </div>
        </div>
      </motion.header>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        {filteredBookings.length > 0 ? (
          ...
          <motion.div
            ...
            variants={fadeIn}
          >
            <div className="bg-white dark:bg-[#1a1f2e] rounded-xl p-12 shadow-md text-center border border-transparent dark:border-[#1e293b]">
              <AlertCircle className="w-16 h-16 text-gray-400 dark:text-slate-500 mx-auto mb-4" />
              <h3 className="text-xl font-semibold text-gray-900 dark:text-slate-100 mb-2">No bookings found</h3>
