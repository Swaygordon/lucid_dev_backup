      ...
      {isOpen && (
        ...
        >
          <motion.div
            ...
            className={`bg-white dark:bg-[#1a1f2e] rounded-2xl shadow-xl ring-1 ring-slate-900/5 dark:ring-white/10 ${sizes[size]} w-full p-8 relative max-h-[90vh] overflow-y-auto`}
